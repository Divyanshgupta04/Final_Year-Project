...
model = joblib.load("models/best_model_MLPClassifier.pkl")  # your model path
scaler = joblib.load("models/paddy_scaler.pkl")  # your scaler path
...
def generate_recommendations(N, P, K, predicted_fertility):
    ...
    messages = ["⚠️ Fertility is below the optimal threshold (11). Soil improvement is needed:"]
...
def predict():
    try:
        ...
        prediction_text = f"🌾 Predicted Paddy Fertility Level: {int(prediction)} (1 = Low, 15 = High)"
